	...
	public sealed class Int64TypeHandler : BaseTypeHandler
	{
		...
		public override object GetValueByName(ResultProperty mapping, IDataReader dataReader)
		{
			...
			else
			{
				...
				{
					long.TryParse(dataReader.GetValue(ordinal).ToString(), out num);
				}
				result = num;
			}
			return result;
		...
		public override object GetValueByIndex(ResultProperty mapping, IDataReader dataReader)
		{
			...
			else
			{
				...
				{
					long.TryParse(dataReader.GetValue(mapping.ColumnIndex).ToString(), out num);
				}
				result = num;
			}
			return result;
		...
		public override object GetDataBaseValue(object outputValue, System.Type parameterType)
		{
			...
			if (outputValue != null)
			{
				long.TryParse(outputValue.ToString(), out num);
			}
			return num;
		}
		...
		public override object ValueOf(System.Type type, string s)
		{
			...
			if (s != null)
			{
				long.TryParse(s.ToString(), out num);
			}
			return num;
		}
	}
