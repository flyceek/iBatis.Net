...
namespace IBatisNet.DataMapper.TypeHandlers
{
	public sealed class DoubleTypeHandler : BaseTypeHandler
	{
		...
		public override object GetValueByName(ResultProperty mapping, IDataReader dataReader)
		{
			...
			{
				result = dataReader.GetDouble(ordinal);
			}
			return result;
		}
		...
		public override object GetValueByIndex(ResultProperty mapping, IDataReader dataReader)
		{
			...
			{
				result = dataReader.GetDouble(mapping.ColumnIndex);
			}
			return result;
		}
		...
		public override object ValueOf(System.Type type, string s)
		{
			...
			if (s != null)
			{
				double.TryParse(s.ToString(), out num);
			}
			return num;
		}
		...
		public override object GetDataBaseValue(object outputValue, System.Type parameterType)
		{
			...
			if (outputValue != null)
			{
				double.TryParse(outputValue.ToString(), out num);
			}
			return num;
		}
	}
