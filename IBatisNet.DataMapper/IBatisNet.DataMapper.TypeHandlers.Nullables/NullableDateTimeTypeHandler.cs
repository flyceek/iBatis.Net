...
namespace IBatisNet.DataMapper.TypeHandlers.Nullables
{
	public sealed class NullableDateTimeTypeHandler : BaseTypeHandler
	{
		...
		{
			System.DateTime? dateTime = (System.DateTime?)parameterValue;
			if (dateTime.HasValue)
			{
				dataParameter.Value = dateTime.Value;
			}
			else
			{
		...
		public override object GetValueByName(ResultProperty mapping, IDataReader dataReader)
		{
			...
			{
				result = new System.DateTime?(dataReader.GetDateTime(ordinal));
			}
			return result;
		}
		...
		public override object GetValueByIndex(ResultProperty mapping, IDataReader dataReader)
		{
			...
			{
				result = new System.DateTime?(dataReader.GetDateTime(mapping.ColumnIndex));
			}
			return result;
		}
		...
		{
			return new System.DateTime?(System.Convert.ToDateTime(outputValue));
		}

		public override object ValueOf(System.Type type, string s)
		{
			return new System.DateTime?(System.Convert.ToDateTime(s));
		}
	}
}
