...
namespace IBatisNet.DataMapper.TypeHandlers.Nullables
{
	public sealed class NullableUInt32TypeHandler : BaseTypeHandler
	{
		...
		public override object GetValueByName(ResultProperty mapping, IDataReader dataReader)
		{
			...
			{
				result = new uint?(System.Convert.ToUInt32(dataReader.GetValue(ordinal)));
			}
			return result;
		}
		...
		public override object GetValueByIndex(ResultProperty mapping, IDataReader dataReader)
		{
			...
			{
				result = new uint?(System.Convert.ToUInt32(dataReader.GetValue(mapping.ColumnIndex)));
			}
			return result;
		}
		...
		{
			return new uint?(System.Convert.ToUInt32(outputValue));
		}
