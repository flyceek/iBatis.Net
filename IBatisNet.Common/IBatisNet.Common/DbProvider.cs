...
namespace IBatisNet.Common
{
	...
	public class DbProvider : IDbProvider
	{
		...
		public bool UseParameterPrefixInSql
		{
			get
			{
				return _useParameterPrefixInSql;
			}
			set
			{
				_useParameterPrefixInSql = value;
			}
		}
		...
		public bool UseParameterPrefixInParameter
		{
			get
			{
				return _useParameterPrefixInParameter;
			}
			set
			{
				_useParameterPrefixInParameter = value;
			}
		}
		...
		public bool UsePositionalParameters
		{
			get
			{
				return _usePositionalParameters;
			}
			set
			{
				_usePositionalParameters = value;
			}
		}
		...
		public bool SetDbParameterSize
		{
			get
			{
				return _setDbParameterSize;
			}
			set
			{
				_setDbParameterSize = value;
			}
		}
		...
		public bool SetDbParameterPrecision
		{
			get
			{
				return _setDbParameterPrecision;
			}
			set
			{
				_setDbParameterPrecision = value;
			}
		}
		...
		public bool SetDbParameterScale
		{
			get
			{
				return _setDbParameterScale;
			}
			set
			{
				_setDbParameterScale = value;
			}
		}
		...
		public bool UseDeriveParameters
		{
			get
			{
				return _useDeriveParameters;
			}
			set
			{
				_useDeriveParameters = value;
			}
		}
		...
		public string ParameterDbTypeProperty
		{
			get
			{
				return _parameterDbTypeProperty;
			}
			set
			{
		...
		public void Initialize()
		{
			...
			try
			{
				...
				type = assembly.GetType(_dataAdapterClass, throwOnError: true);
				...
				type = assembly.GetType(_connectionClass, throwOnError: true);
				...
				_commandBuilderType = assembly.GetType(_commandBuilderClass, throwOnError: true);
				...
				{
					_parameterDbType = assembly.GetType(_parameterDbTypeClass, throwOnError: true);
				}
			...
			{
				throw new ConfigurationException($"Could not configure providers. Unable to load provider named \"{_name}\" not found, failed. Cause: {ex.Message}", ex);
			}
		}
		...
		{
			return _useParameterPrefixInSql ? (_parameterPrefix + parameterName) : "?";
		}
		...
		public override bool Equals(object obj)
		{
			...
			{
				IDbProvider dbProvider = (IDbProvider)obj;
				return _name == dbProvider.Name && _assemblyName == dbProvider.AssemblyName && _connectionClass == dbProvider.DbConnectionClass;
			}
			return false;
		}
